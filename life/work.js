...
var  addSql = 'INSERT INTO income(Id,name,url,alexa,country) VALUES(0,?,?,?,?)';
...
app.get('/api/one',jsonParser, (req, res) => {
//查
...
app.post('/edit',jsonParser, (req, res) => {
  ...
  var modSql = 'UPDATE income SET alexa = ?, country = ?, name = ?,url = ? WHERE Id = ?';
